...
const HomePage = () => {
  ...
  return (
    <div className="relative">
      ...
      {/* Impact Section */}
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-space-dark/80 to-space-darker/80 border-b border-neon-blue/20">
        <div className="max-w-7xl mx-auto">
          <motion.div
          ...
          >
            ...
            <p className="text-xl text-foreground/70 max-w-2xl mx-auto">
              Committed to creating meaningful change through technology, mentorship, and social responsibility
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <motion.div
              ...
              transition={{ duration: 0.6 }}
              viewport={{ once: true }}
              className="bg-gradient-to-br from-neon-blue/10 to-neon-blue/5 border border-neon-blue/30 rounded-xl p-6 hover:border-neon-blue/60 transition-all duration-300"
            >
              <div className="text-4xl mb-4">👥</div>
              <h3 className="text-xl font-bold text-neon-blue mb-3">Our Team</h3>
              <p className="text-foreground/80">
                Passionate professionals dedicated to delivering excellence and driving innovation across all projects
              </p>
            </motion.div>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-gradient-to-br from-neon-yellow/10 to-neon-yellow/5 border border-neon-yellow/30 rounded-xl p-6 hover:border-neon-yellow/60 transition-all duration-300"
            >
              <div className="text-4xl mb-4">🌍</div>
              <h3 className="text-xl font-bold text-neon-yellow mb-3">Sustainable Development Goals</h3>
            ...
            >
              <div className="text-4xl mb-4">🎓</div>
              <h3 className="text-xl font-bold text-neon-blue mb-3">Mentorship Program</h3>
              <p className="text-foreground/80">
                Nurturing young talent through guidance, training, and real-world experience in digital innovation
              </p>
            </motion.div>
            ...
            >
              <div className="text-4xl mb-4">🤝</div>
              <h3 className="text-xl font-bold text-neon-yellow mb-3">Corporate Social Responsibility</h3>
              <p className="text-foreground/80">
                Building sustainable communities through technology initiatives and giving back to society
              </p>
            </motion.div>
          </div>
        </div>
