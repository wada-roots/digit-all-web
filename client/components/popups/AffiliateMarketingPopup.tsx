    ...
    >
      ...
      <div className="text-center mb-8">
        ...
        <div className="flex items-center justify-center mt-4 space-x-2">
          ...
          <span className="bg-neon-blue text-white px-2 py-1 rounded text-xs font-bold">
            20% COMMISSION
          </span>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="bg-space-light/30 p-6 rounded-lg border border-neon-blue/20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <Label htmlFor="affiliateName" className="text-foreground/90">
                Full Name *
              </Label>
              <Input
                id="affiliateName"
            ...
            <div>
              <Label htmlFor="affiliateEmail" className="text-foreground/90">
                Email Address *
              </Label>
              <Input
                id="affiliateEmail"
          ...
          <div className="mt-4">
            <Label htmlFor="affiliatePhone" className="text-foreground/90">
              Phone Number *
            </Label>
            <Input
              id="affiliatePhone"
        ...
        <div className="bg-space-light/30 p-6 rounded-lg border border-neon-yellow/20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <Label htmlFor="clientName" className="text-foreground/90">
                Client Full Name *
              </Label>
              <Input
                id="clientName"
            ...
            <div>
              <Label htmlFor="clientEmail" className="text-foreground/90">
                Client Email *
              </Label>
              <Input
                id="clientEmail"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
            <div>
              <Label htmlFor="clientPhone" className="text-foreground/90">
                Client Phone *
              </Label>
              <Input
                id="clientPhone"
            ...
            <div>
              <Label htmlFor="clientCompany" className="text-foreground/90">
                Company/Business
              </Label>
              <Input
                id="clientCompany"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
            <div>
              <Label htmlFor="clientService" className="text-foreground/90">
                Service Needed *
              </Label>
              <Select
                onValueChange={(value) =>
                  setFormData((prev) => ({ ...prev, clientService: value }))
                }
              >
            ...
            <div>
              <Label htmlFor="clientBudget" className="text-foreground/90">
                Estimated Budget
              </Label>
              <Select
                onValueChange={(value) =>
                  setFormData((prev) => ({ ...prev, clientBudget: value }))
                }
              >
                <SelectTrigger className="bg-space-light border-space-light">
      ...
      <div className="mt-6 p-4 bg-neon-blue/10 rounded-lg border border-neon-blue/20">
        <p className="text-xs text-foreground/70 text-center">
          💰 Earn 20% commission on every successful referral! Free to join,
          monthly payouts.
        </p>
      </div>
    </motion.div>
